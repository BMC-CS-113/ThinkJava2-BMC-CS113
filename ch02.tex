...
Put the following lines in a java file and try to compile the file. What error messages
does the compiler tell you about?
...
When a variable name contains more than one word (like \java{firstName}), it is conventional to capitalize the first letter of each subsequent word. We refer to this as camel case.\footnote{If it isn't clear why we call this camelCase, think of sally the camel \url{https://www.youtube.com/watch?v=2b1sHZXL1ac}}.
...
Most programming editors (including vim) provide ``syntax highlighting'', which makes different parts of the program appear in different colors.
...
\end{code}
\\Copy this previous example to a java file and compile the file. What is the
...
\section{Operators for Strings}\label{sec:ch02-string}

\index{string!operator}
\index{operator!string}

In general, you cannot perform mathematical operations on strings, even if the strings look like numbers.
The following expressions are illegal:\footnote{Copy these expressions to a file and compile the file. What are the error messages that you see?}
...
That's pretty good: the location of the error (line 5) is correct, and the error message tells you what's wrong.
