...
In the past several chapters, you've seen methods, conditions, 
%loops, strings, 
%arrays, 
and recursion.
...
%, and the other deals with arrays.
...
The code for this chapter is in the {\it ch08}\change{update the code directory} directory of {\it ThinkJavaCode2}.
