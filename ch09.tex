...
\begin{code}
String name = "Karen Sparck Jones";
String upperName = name.toUpperCase();
\end{code}

%\index{Turing, Alan}

After these statements run, \java{upperName} refers to the string \java{"KAREN SPKARCK JONES"}.
But \java{name} still refers to \java{"Karen Sparck Jones"}.\footnote{Karen Sparck Jones developed the algorithm that powers most search enginers \url{https://www.nytimes.com/2019/01/02/obituaries/karen-sparck-jones-overlooked.html}.}
...
The previous code displays \java{"Karen Sparck Jones"}, because the value of \java{name}, which refers to the original \java{String} object, never changes.
